      ...
      <PageHeader
        ...
        actions={
          <>
            ...
            <Button size="sm" onClick={() => setShowAddAlert(true)}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p className="font-medium">{new Date(alert.lastTriggered).toLocaleDateString()}</p>
                        </div>
                      </div>
                    </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-green-50 rounded-lg">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-green-900">New Property Match</h4>
              ...
              <div className="flex items-center space-x-4 p-4 bg-blue-50 rounded-lg">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-blue-900">Market Update</h4>
              ...
              <div className="flex items-center space-x-4 p-4 bg-yellow-50 rounded-lg">
                ...
                <div className="flex-1">
                  <h4 className="font-medium text-yellow-900">ROI Opportunity</h4>
