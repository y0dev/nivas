      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-xl font-bold text-gray-900">UrbanInsight</h1>
            <button
          ...
          <div className="border-t border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm font-medium text-gray-700">John Investor</p>
                <p className="text-xs text-gray-500">Premium Member</p>
              </div>
            </div>
            <button className="mt-3 flex w-full items-center px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:text-gray-900 rounded-md">
