        ...
        <div className="relative h-full flex items-center justify-center">
          <div className="text-center text-white px-8">
            <div className="mb-8">
              ...
              <h3 className="text-3xl font-bold mb-4">UrbanInsight</h3>
              <p className="text-xl text-blue-100 mb-6">Find the best property deals and investment opportunities</p>
            </div>
