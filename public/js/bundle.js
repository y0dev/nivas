...
var deleteUserAccount = exports.deleteUserAccount = /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16() {
    var confirmDelete, res, data;
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          confirmDelete = confirm("Are you sure you want to delete your account? This action cannot be undone.");
          if (!confirmDelete) {
            _context16.next = 20;
            break;
          }
...
},{"./controller.user":"controller.user.js"}],"controller.stripe.js":[function(require,module,exports) {
var define;
"use strict";
...
var _controller5 = require("./controller.stripe");
...
if (pricingSection) {
  ...
  if (tier1Btn && tier2Btn && tier3Btn) {
    tier1Btn.addEventListener("click", function () {
      (0, _controller5.subscribe)("free");
    });
    tier2Btn.addEventListener("click", function () {
      (0, _controller5.subscribe)("basic");
    });
    tier3Btn.addEventListener("click", function () {
      (0, _controller5.subscribe)("premium");
    });
  }
}
if (contactForm) {
...
},{"./header/theme":"header/theme.js","./header/notification":"header/notification.js","./solutions":"solutions.js","./controller.email":"controller.email.js","./controller.mls":"controller.mls.js","./controller.navbar":"controller.navbar.js","./controller.user":"controller.user.js","./controller.stripe":"controller.stripe.js","./dashboard/chart":"dashboard/chart.js","./dashboard/navbar":"dashboard/navbar.js","./tablesort":"tablesort.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
