...
},{}],"create.email.js":[function(require,module,exports) {
var define;
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "http://localhost:".concat("3010", "/api/v1/contactUs"),
            data: {
              name: name,
              email: email,
              phone: phone,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = "http://localhost:".concat("3010", "/api/v1/mls/searchZip");
          data = {
            zip_code: zip_code
          };
          _context.next = 20;
        ...
        case 10:
          ...
          url = "http://localhost:".concat("3010", "/api/v1/mls/searchCS");
          data = {
            city: city,
            state: state
          };
...
var _create = require("./create.email");
var _create2 = require("./create.mls");
...
if (dashboard) {
  ...
  if (mlsForm) {
    mlsForm.addEventListener("submit", function (e) {
      ...
      (0, _create2.searchForMLS)(mls_input);
    });
  }
}
if (contactForm) {
