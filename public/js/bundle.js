...
>>>>>>> 56f028f (refactor controller.mls)
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
var searchForMLS = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(mls_string) {
    var url, data, zip_code, _getCityAndState, city, state, token, res, _res$data, zipCode, cityState, listings, twoBedsQuartile, threeBedsQuartile, status;
>>>>>>> 56f028f (refactor controller.mls)
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
<<<<<<< HEAD
            ...
            //   }, 1500);
=======
            updateSearchResults(zipCode, cityState, listings, twoBedsQuartile, threeBedsQuartile);
>>>>>>> 56f028f (refactor controller.mls)
          }
          _context.next = 27;
          break;
...
=======
          (0, _alert.showAlert)("error", "There was an error downloading the results");
>>>>>>> 56f028f (refactor controller.mls)
        case 11:
        case "end":
...
<<<<<<< HEAD
          (0, _utilities.showAlert)("error", "There was an error logging you out");
=======
          (0, _alert.showAlert)("error", "There was an error retrieving the search history");
>>>>>>> 56f028f (refactor controller.mls)
        case 11:
        case "end":
