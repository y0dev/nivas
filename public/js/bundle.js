...
var searchForMLS = exports.searchForMLS = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(mls_string) {
    var url, data, zip_code, _getCityAndState, city, state, token, res, _res$data, zipCode, cityState, listings, _coordinates, twoBedsQuartile, threeBedsQuartile, status;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 19:
          res = _context.sent;
          _res$data = res.data, zipCode = _res$data.zipCode, cityState = _res$data.cityState, listings = _res$data.listings, _coordinates = _res$data.coordinates, twoBedsQuartile = _res$data.twoBedsQuartile, threeBedsQuartile = _res$data.threeBedsQuartile, status = _res$data.status;
          if (status === "success") {
            updateSearchResults(zipCode, cityState, listings, _coordinates, twoBedsQuartile, threeBedsQuartile);
          }
          _context.next = 27;
          break;
        case 24:
...
function updateSearchResults(zipCode, cityState, listings, twoBedsQuartile, threeBedsQuartile) {
  ...
  listings.forEach(function (listing) {
    return addListingToTable(tbody, listing, twoBedsQuartile, threeBedsQuartile);
  });
}
