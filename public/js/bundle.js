        ...
        case 25:
          ...
          if (res.data.status === "success") {
            ...
            if (tableDisplay === "none") {
              ...
              "block", _readOnlyError("tableDisplay");
            }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)("error", "There was an error loggin you out");
        case 10:
        case "end":
...
var _controller3 = require("./controller.user");
...
if (signupForm) {
  ...
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _controller3.signup)(name, email, password, passwordConfirmed);
  });
}
if (loginForm) {
  // Remove signup nav link from navbar
  ...
  loginForm.addEventListener("submit", function (e) {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value;
    (0, _controller3.login)(email, password);
  });
}
if (mainWrapper) {
  var hamburgerBtn;
...
},{"./controller.email":"controller.email.js","./controller.mls":"controller.mls.js","./controller.user":"controller.user.js","./tablesort":"tablesort.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
